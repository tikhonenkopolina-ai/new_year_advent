...
Я, моё терпение, ChatGPT, Render и GitHub сделали для тебя новогодний адвент ❤️""",
        "media": [
...
Это было познавательно и мне было очень ценно, что ты позвал меня с собой ❤️""",
        "media": [
...
Хотя тебе, конечно, больше подойдёт борщ с салом и лагер ❤️""",
        "media": [
